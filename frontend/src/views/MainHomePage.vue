...
.info_car {
  ...
  text-align: center;
  color: white;
  background: url(D:/proj/ESC/frontend/src/assets/img/tycan2.jpg) no-repeat
    center scroll;
...
.intro {
  ...
  text-align: center;
  color: white;
  background: url(https://org1-www.hyundai.com/content/dam/hyundai/kr/ko/images/brand/brandstory/eco/eco-fuel-cell-electric-vehicle-keyvisual-w.jpg)
