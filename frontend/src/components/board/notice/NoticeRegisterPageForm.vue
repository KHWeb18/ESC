...
export default {
        ...
        methods: {
            ...
            axios.post(`https://evsbackend.herokuapp.com/notice/uploadImg/${this.session.memberId}/${this.randomNumToString}`, formData,{ headers: {'Content-Type': 'multipart/form-data'} })
            .then (res => {
